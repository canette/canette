...
import { listProjects, createProject, getProjectByRef } from "./projects"
...
export async function handleTool(name: string, args: Record<string, unknown>, userId: string): Promise<ToolResult> {
  try {
    switch (name) {
      case "list_projects": {
