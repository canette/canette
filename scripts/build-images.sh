...
echo ""
echo "Helm values:"
echo "  --set api.image=${API_IMAGE}:${TAG}"
echo "  --set ui.image=${UI_IMAGE}:${TAG}"
echo "  --set builder.image=${BUILDER_IMAGE}:${TAG}"
echo "  --set builder.gitInitImage=${GIT_INIT_IMAGE}:${TAG}"
echo "  --set builder.builderImage=${IMAGE_BUILD_IMAGE}:${TAG}"
echo "  --set controller.image=${CONTROLLER_IMAGE}:${TAG}"
echo "  --set logstreamer.image=${LOGSTREAMER_IMAGE}:${TAG}"
